      ...
      <MuiThemeProvider theme={custom}>
            ...
            <Grid container className={classes.root} spacing={16}>
              ...
              <Grid item sm={6} lg={6} xl={5}>
                <FormControl fullWidth className={classNames(classes.margin, classes.textField)}>
                  <InputLabel htmlFor="password">Senha (8-15 caractéres)</InputLabel>
        ...
        <Grid container className={classes.someSpace} justify="space-between" spacing={16}>
          <Grid container item sm={3} justify="center">
            <Button variant="contained" color="primary">Carregar foto</Button>
          </Grid>
          <Grid container item sm={9} justify="flex-end">
            <Button className={classes.btnMargin} variant="contained" color="primary">Salvar mudanças</Button>
            <Button className={classes.btnMargin} variant="contained" color="secondary">Cancelar</Button>
          </Grid>
        </Grid>
